    ...
    , mPushProjectionToFront( false )
{
  ...
  mSrsDatabaseFileName = srsDbFilePath;
...
//  QgsDebugMsg( "USER_CRS_START_ID = " + QString::number( USER_CRS_START_ID ) );
  ...
  {
    databaseFileName = qgisUserDbFilePath;
...
void QgsProjectionSelector::loadCrsList( QSet<QString> *crsFilter )
{
  ...
  mGeoList->setIcon( 0, QIcon("/geographic.png") );
  ...
  mProjList->setIcon( 0, QIcon("/transformed.svg")  );
