...
(function(jQuery) {
	jQuery.fn.easyShare = function(options) {
		...
		settings = {			
			...
			imagePath: '',
			mode: 'normal',
			bookmarkText: 'Veuillez presser "Ctrl+D" ou "Cmd+D" pour Mac afin d\'ajouter cette page � vos favoris'
		};
		...
		setContent = function(obj) {
			...
			// Fermeture quand click � l'exterieur
			// On bind l'event � la vol�e pour de meilleurs performances
